...
# %% Pure CNN Model Definition (GÜNCELLENDİ: L2 Reg parametresi eklendi)
def build_seizure_model_cnn(input_shape, learning_rate=0.001, threshold=0.50, dropout_factor=0.25, l2_reg=0.001):
    ...
    # Classification Head (GÜNCELLENDİ: Daha düşük L2 cezası)
...
for dataset_path in dataset_paths:
    ...
    for train_idx, test_idx in logo.split(X, y, groups=groups):
        ...
        with strategy.scope():
            # GÜNCELLENDİ: Dropout 0.25 ve L2 0.001 olarak çağrılıyor
